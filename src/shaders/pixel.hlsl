...
{
    float4 srcColor = colorMap.Sample(colorSampler, frag.tex0.xy);
    ...
    float3 lightDir = normalize(lightPos - frag.fragPos);
    ...
    float3 viewDir = normalize(frag.viewPos - frag.fragPos);
    ...
    return float4(result, srcColor.a);
}
